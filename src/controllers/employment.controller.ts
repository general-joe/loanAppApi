...
export const saveEmploymentRecords = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
  try {
    ...
    res.status(HttpStatus.CREATED).json({message:"employment data saved successfully", records });
  } catch (error) {
...
export const getEmploymentRecordsById = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
...
export const updateEmploymentRecords = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
  try {
    ...
    res
      ...
      .json({ message: "Employment Records updated successfully", records });
  } catch (error) {
    const err = error as ErrorResponse;
    next(
      new HttpException(
...
export const deleteEmploymentRecords = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
  try {
    ...
    res
      .status(HttpStatus.OK)
      .json({ message: "Employment records deleted successfully", records });
  } catch (error) {
    const err = error as ErrorResponse;
    next(
      new HttpException(
